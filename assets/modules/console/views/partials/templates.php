...
<script type="text/html" id="template_controls">
	<li class="button" data-show="output"><span class="title">Ответ:</span> <span class="time_queries">{{=niceBytesize(output_size)}}</span></li>
	<li class="execution help" title="Script execution / Laravel total">
		<span class="title">Время выполения:</span>
	...
	<li class="memory help" title="Current memory / Memory peak">
		<span class="title">Память:</span> <span class="memory">{{=niceBytesize(memory)}}<span class="divider">/</span>{{=niceBytesize(memory_peak)}}</span>
	</li>
</script>
